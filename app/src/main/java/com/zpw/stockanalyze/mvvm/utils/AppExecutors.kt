...
open class AppExecutors {
    private val TAG: String = AppExecutors::class.java.simpleName
    ...
    constructor() {
        ...
        poolExecutor = object : ThreadPoolExecutor(
            ...
            override fun beforeExecute(t: Thread, r: Runnable) {
                ...
                if (isPause) {
                    ...
                    try {
                        ...
                        Timber.d(TAG, "beforeExecute:$exception")
                    } finally {
                        lock.unlock()
                    }
                }
            ...
            override fun afterExecute(r: Runnable, t: Throwable) {
                ...
                Timber.d(TAG, "this thread priority is " + (r as PriorityRunnable).priority)
            }
        }
    }
    ...
    fun pause() {
        ...
        try {
            isPause = true
            Timber.d(TAG, "thread pool is paused")
        } finally {
            lock.unlock()
        }
    }
    ...
    fun resume() {
        ...
        Timber.d(TAG, "thread pool is resumed")
    }
