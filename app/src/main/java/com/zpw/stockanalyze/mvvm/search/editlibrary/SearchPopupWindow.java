...
import com.zpw.stockanalyze.mvvm.search.editlibrary.entity.MultipleItemEntity;
import com.zpw.stockanalyze.mvvm.search.editlibrary.entity.TitleEntity;
...
class SearchPopupWindow extends PopupWindow {
    ...
    SearchPopupWindow(Activity activity,int popup_width,int popup_height){
    ...
    private void initView(){
        ...
        setHeight(getPixelsFromDp(popup_height));
